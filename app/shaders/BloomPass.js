// Adapted from https://github.com/mrdoob/three.js/blob/dev/examples/jsm/postprocessing/UnrealBloomPass.js
		...
		return new ShaderMaterial( {
			...
			fragmentShader:
				...
				void main() {
					...
					vec3 diffuseSum = color.rgb * weightSum;
					float alphaSum = color.a * weightSum;
					...
					gl_FragColor = vec4(diffuseSum/weightSum, alphaSum/weightSum/0.8);
				}`
		} );
	}
